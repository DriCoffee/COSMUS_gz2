...
class CesnaPidController(Node):
    def __init__(self):
        ...
        self.declare_parameter('surface_min', -1.0)
        self.declare_parameter('surface_max', 1.0)
